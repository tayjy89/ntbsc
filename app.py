...
def main():
    ...
    with tabs[0]:
        ...
        edited = st.data_editor(consultants_df, num_rows="dynamic", use_container_width=True)
        ...
        edited_d = st.data_editor(defaults_df, num_rows="dynamic", use_container_width=True)
